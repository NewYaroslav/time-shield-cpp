...
**Time Shield** — это ~~не только оружие Хомуры Акэми, но и~~ заголовочная C++-библиотека для работы со временем. Она включает функции для конвертации временных значений, форматирования дат и множество утилит для ежедневных задач с таймстампами.
...
Библиотека поставляется в виде заголовков. Для подключения достаточно добавить путь `include` в проект и подключить основной файл:
