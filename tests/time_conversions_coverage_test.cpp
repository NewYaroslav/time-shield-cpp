...
int main() {
    ...
    assert(ms_to_sec(-1) == -1);
    assert(ms_to_sec(-1000) == -1);
    assert(ms_to_sec(-1001) == -2);
    ...
    assert(ms_part(-1) == 999);
    assert(ms_part(-1000) == 0);
    assert(ms_part(-1001) == 999);
    assert(us_part(static_cast<ts_us_t>(-1)) == 999999);
    assert(ns_part(-1) == 999999999);
    assert(ms_of_sec(-1.2) == 800);
    assert(us_of_sec(-1.2) == 800000);
    assert(ns_of_sec(-1.2) == 800000000);
    ...
    assert(start_of_year(epoch_start) == to_timestamp(1970, 1, 1));
    assert(end_of_year(epoch_start) == to_timestamp(1970, 12, 31, 23, 59, 59));
    const ts_t leap_day_2000 = to_timestamp(2000, 2, 29);
    assert(start_of_year(leap_day_2000) == to_timestamp(2000, 1, 1));
    assert(end_of_year(leap_day_2000) == to_timestamp(2000, 12, 31, 23, 59, 59));
    const ts_t march_1900 = to_timestamp(1900, 3, 1);
    assert(start_of_year(march_1900) == to_timestamp(1900, 1, 1));
    assert(end_of_year(march_1900) == to_timestamp(1900, 12, 31, 23, 59, 59));
    const ts_t march_2100 = to_timestamp(2100, 3, 1);
    assert(start_of_year(march_2100) == to_timestamp(2100, 1, 1));
    assert(end_of_year(march_2100) == to_timestamp(2100, 12, 31, 23, 59, 59));
    ...
    assert(min_year_start <= min_ts);
    assert(min_year_end >= min_ts);
    assert(start_of_year(min_year_end) == min_year_start);
    assert(end_of_year(min_year_start) == min_year_end);
    const ts_t max_year_start = start_of_year(max_ts);
    const ts_t max_year_end = end_of_year(max_ts);
    assert(max_year_start <= max_ts);
    assert(max_year_end >= max_ts);
    assert(year_of(max_year_start) == year_of(max_ts));
    assert(is_valid_date(MAX_YEAR, 1, 1));
    assert(is_valid_date(MIN_YEAR, 1, 1));
    assert(year_of(max_ts) <= MAX_YEAR);
    assert(year_of(min_ts) >= MIN_YEAR);
